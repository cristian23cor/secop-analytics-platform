...
se genera solo desde los datos.
...
Un vendedor que le quiere vender al Estado se hace preguntas de negocio. Algunas se
...
> ¿Qué entidades alargan sistemáticamente los plazos, y cuántos días?
>
> ¿Cuánto cuesta ese alargue en pesos?
...
reconstruye el cuánto comparando.
...
scripts/
  se corren a mano
    ...
    actualizar.sh                    Los tres pasos en orden: cargar, construir, publicar
