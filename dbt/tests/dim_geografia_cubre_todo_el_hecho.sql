{#-
  ...
  Mismo invariante y mismo modo de fallo que `dim_modalidad_cubre_todo_el_hecho`:
  si los dos cálculos del hash divergieran, la unión omitiría filas en silencio.
  Un `join` sin pareja no falla — los totales bajan y hay que sospechar del
  número para notarlo.
